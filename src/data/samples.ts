...
export const SAMPLE_INVITES: SampleInvite[] = [
  {
    ...
    time: '6:30 PM Onwards (Muhurat: 7:15 PM)',
  ...
  },
  {
    ...
    categoryLabel: 'Griha Pravesh',
    icon: Home,
    tagline: 'Traditional Emerald & Auspicious Kalash Motifs',
    badge: '🏡 Griha Pravesh',
    badgeColor: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    date: 'February 12, 2027',
    time: '9:00 AM Pooja • 12:30 PM Maha Prasad',
    location: 'Villa 42, Prestige Green Woods, Whitefield',
    coupleOrHost: 'The Mehta Family',
    messages: [
      'With the divine blessings of Almighty and elders, we are stepping into our new home. We warmly invite you and your family for the auspicious Pooja and Lunch.',
